...
if __name__ == "__main__":
    ...
    # Build result: for each vertex, collect its assigned colors
    assignments = {}
    max_color = 0
    for v in V:
        vertex_colors = []
