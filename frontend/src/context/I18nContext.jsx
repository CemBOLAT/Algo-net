...
const translations = {
  en: {
    ...
    file_info_select_colored: 'Colored Example',
    file_info_select_json: 'JSON File',
    colored_example_title: 'Add Colored Graph - Info',
    colored_example_desc: 'Specify a vertex color at the end of each line in quotes:',
    colored_example_note: 'Supports CSS color names (e.g. "purple", "pink") and hex codes (e.g. "#ff6b35"). Vertex-only lines set a color with no edges. Existing plain/weighted formats still work.',
    json_example_title: 'Add Graph via JSON - Info',
    json_example_desc: 'Upload a .json file with "nodes" and "edges" arrays matching this structure:',
    json_example_note: 'Required node fields: nodeId, label. Optional: color, positionX, positionY, size. Required edge fields: fromNode, toNode. Optional: weight, isDirected, color.',
    ...
    bulk_add_subtitle: 'Bulk Add Vertices (e.g., 10)',
    ...
    quickgraph_Ahmet_Melih: 'Packing Coloring',
    ...
    next_page: 'Next page',
    quickgraph_random_info_disabled: 'Select node count and network type to generate a random topology.',
    quickgraph_random_created: 'Random graph generated successfully.',
    quickgraph_err_random_failed: 'Failed to generate random graph from server.',
    ...
    normal_coloring: 'Exact Coloring (MIP)',
    ...
    result_path: 'Path',
    result_visited: 'Visited',
    result_nodes: 'nodes',
    result_distance: 'Total Distance',
    result_shortest_path: 'Shortest Path',
    result_edges_used: 'Edges Used',
    result_colors_used: 'Colors Used',
    result_color_mapping: 'Color → Nodes',
    result_layout_done: 'Layout Complete',
    result_layout_desc: 'Nodes repositioned and colored by facility type.',
    clear_results: 'Clear',
    // Bulk Tools
    bulk_tools_title: 'Bulk Tools',
    add_vertices_tab: 'Add Vertices',
    add_edges_tab: 'Add Edges',
    bulk_nodes_desc: 'Instantly generate multiple nodes with sequential labels (e.g., 1, 2, 3...) placed randomly on the canvas.',
    num_nodes_label: 'Number of Nodes',
    add_nodes_btn: 'Add Nodes',
    bulk_edges_desc: 'Select a source node and multiple target nodes to link them instantly.',
    from_source_label: 'From (Source)',
